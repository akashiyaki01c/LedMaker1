...
pub fn svg_to_png(svg: &str) -> Vec<u8> {
    let rtree = {
        ...
        fontdb.load_font_source(fontdb::Source::Binary(Arc::new(include_bytes!("./fonts/NotoSansJP-Bold.ttf"))));
        fontdb.load_font_source(fontdb::Source::Binary(Arc::new(include_bytes!("./fonts/Ubuntu-Bold.ttf"))));
        fontdb.load_font_source(fontdb::Source::Binary(Arc::new(include_bytes!("./fonts/RobotoCondensed-Bold.ttf"))));
